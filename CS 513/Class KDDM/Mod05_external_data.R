...
Titanic<-
     read.csv("C://Users/Administrator/OneDrive - stevens.edu/___Data/CSV_files/Titanic_rows.csv")
...
con<-file("C://Users/Administrator/OneDrive - stevens.edu/___Data/CSV_files/Titanic_rows.csv",'r')
